...
if duration == 15:
    positive_spike_average = 2.13 * Hz
    negative_spike_average = 2 * Hz
elif duration == 30:
    positive_spike_average = 3.87 * Hz
    negative_spike_average = 2 * Hz

#eeg channel connection
input_group_ME = PoissonGroup(1, rates=positive_spike_average)
input_ME = Synapses(input_group_ME, E, on_pre='v_post += 1.5')
input_ME.connect(i=0,j=[0, 1, 8,9])

input_group_MI = PoissonGroup(1, rates=negative_spike_average)
...
'''
visualise_connectivity(S_EE,0.5)
